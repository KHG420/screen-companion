...
这是可继续开发和测试的 0.4.0 测试版。不含账号、远程控制或录屏存储。共享时支持采集 Android 10+ 允许捕获的媒体/游戏声音，并与麦克风混合发送。没有真机验证的高清/低延迟承诺。屏幕视频、麦克风及共享媒体声音经 WebRTC 传输，信令 HTTP 长轮询只交换 SDP、ICE 和共享状态，不转发媒体。
